  ...
  adalConfig: {
    ...
    protectedResourceMap: {
      'http://localhost:51830': [
        '3dffe4e2-02fa-4e72-884d-189770c6bd66/Resource.Read.All',
      ],
      'http://localhost:51770': [
        'c4e574ef-810e-44a3-be08-17f59be1a845/Resource.ReadWrite',
        'c4e574ef-810e-44a3-be08-17f59be1a845/Resource.Read.All',
      ],
      'http://localhost:51800': [
        '7ba8ee68-418b-4f2d-b1eb-57cf1cba79ce/Resource.Search.All',
      ],
    },
