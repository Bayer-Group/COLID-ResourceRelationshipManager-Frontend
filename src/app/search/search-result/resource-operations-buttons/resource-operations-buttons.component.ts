...
import { FavoritesState } from 'src/app/state/favorites.state';
...
import { ResourceCreationType } from 'src/app/shared/models/resource-creation-type';
import { FetchSearchResult } from 'src/app/state/search.state';
import {
