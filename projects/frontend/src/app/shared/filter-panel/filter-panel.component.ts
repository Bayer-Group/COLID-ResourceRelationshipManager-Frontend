...
import { ResetActiveAggregationBuckets, SearchState, SearchStateModel } from '../../state/search.state';
import { RangeFilter } from '../../shared/range-filter';
import { ActiveRangeFilters } from '../../shared/active-range-filters';
import { Constants } from '../../shared/constants';
import { ClearResourceTypeItem, FetchResourceTypeHierarchy } from '../../state/metadata.state';
...
export class FilterPanelComponent implements OnInit, OnDestroy {
  ...
  @Select(SearchState.getAggregations) getAggregations$: Observable<Aggregation[]>;
  ...
  ngOnInit() {
    ...
    this.masterSub.add(this.aggregationFilters$.subscribe(aggregationFilters => {
    ...
    this.masterSub.add(this.activeAggregations$.subscribe(activeAggregations => {
