...
import { ClearFilter, GraphProperties, GraphVisualisationState, ShowConnectionNames, ShowLongNames, ToggleFilterView } from 'projects/frontend/src/app/state/graph-visualisation.state';
...
export class ViewComponent implements OnInit {
  ...
  @Select(GraphVisualisationState.getGraphVisualisationState) graphSettings$: Observable<GraphProperties>;
