...
import { AddToLinkEditHistory, EnableLinkingMode, GraphLinkingData, GraphLinkingDataState, ResetLinking } from 'projects/frontend/src/app/state/graph-linking.state';
          ...
          if (linkingProperties.linkNodes.length == 2) {
            ...
            dialogRef.afterClosed().subscribe((result: LinkTypeContainer) => {
              if (result != null) {
                ...
                this.store.dispatch(new AddToLinkEditHistory(result, LinkHistoryAction.Add));
